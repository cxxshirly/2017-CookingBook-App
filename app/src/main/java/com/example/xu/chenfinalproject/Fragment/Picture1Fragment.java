 ...
 * Use the {@link Picture1Fragment#newInstance} factory method to
...
public class Picture1Fragment extends Fragment {
    ...
    public static Picture1Fragment newInstance(String param1, String param2) {
        Picture1Fragment fragment = new Picture1Fragment();
...
//        Log.d("Fragment","onCreate");
    ...
    public void onStart() {
        super.onStart();
        UtilLog.d("Fragement","pic1:onStart");
    ...
    public void onResume() {
        super.onResume();
        UtilLog.d("Fragement","Pic1:onResume");
    ...
    public void onPause() {
        super.onPause();
        UtilLog.d("Fragement","Pic1:onPause");
    ...
    public void onStop() {
        super.onStop();
        UtilLog.d("Fragement","Pic1:onStop");
    ...
    public void onDestroy() {
        super.onDestroy();
        UtilLog.d("Fragement","Pic1:onDestroy");
